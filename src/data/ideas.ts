...
export interface ProjectIdea {
  ...
  category: "web" | "mobile" | "api" | "tool" | "ai" | "automation" | "opensource" | "isp" | "fintech" | "scheduling" | "social" | "gaming";
  motivation?: string;
  challenges?: string[];
  features?: string[];
...
export const projectIdeas: ProjectIdea[] = [
  ...
  },
  {
    ...
    collaboratorsNeeded: [
      ...
      "Network engineer with MikroTik experience",
      "Frontend developer",
      "DevOps engineer"
    ],
    ...
    dockerImages: [
      "stephenmuli/isp-api:latest", 
      "stephenmuli/isp-worker:latest", 
      "stephenmuli/isp-web:latest"
    ],
  ...
  },
  {
    ...
    collaboratorsNeeded: [
      ...
      "UI/UX designer with gaming aesthetic",
      "Community manager with esports experience",
      "Blockchain developer for escrow (optional)"
    ],
  ...
  },
  {
    ...
    collaboratorsNeeded: [
      ...
      "UI/UX designer",
      "Financial advisor for compliance"
    ],
...
export function getUpcomingIdeas(): ProjectIdea[] {
  return projectIdeas.filter(
    (idea) => idea.status !== "on-hold"
  ).sort((a, b) => {
...
export function getIdeaBySlug(slug: string): ProjectIdea | undefined {
  return projectIdeas.find((idea) => idea.slug === slug);
}

export function getIdeasSeekingCollaborators(): ProjectIdea[] {
  return projectIdeas.filter((idea) => idea.seekingCollaborators);
}